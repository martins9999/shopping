//=================================================================//
import {
        CONTAINER_P_I_S, CONTENT_P_I_S,
        TITLE_P_I_S, IMG_P_I_S, DESCRIPTION_P_I_S,
        CLOSE_BUTTON_P_I_S,
        CODE_ID_P_I_S,
        BUTTON_SELECT,
        ...
        <CONTAINER_P_I_S>
            {
                productInformation.map((it) => (
                    <CONTENT_P_I_S key={it.productInfo.id}>  
                        <IMG_P_I_S alt="" src={it.productInfo.imag} />
                        <TITLE_P_I_S>{it.productInfo.title}</TITLE_P_I_S>
                        <BUTTON_OPEN_OPTIONS>
                        ...
                        <DESCRIPTION_P_I_S>
                            <b><FaMoneyBills /> À vista { formatCurrency(selectValue * 1)}</b>
                            <div><FaPix /> No Pix {formatCurrency(selectValuePix * 1)}</div>
                            <h6>Descrição</h6>
                        ...
                        {(it.productInfo.color_1 ?? undefined ?
                                <OPTION_BUTTONS_CONTAINER display={optionButtons ? 'flex' : 'none'} >
